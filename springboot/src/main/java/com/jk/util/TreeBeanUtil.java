...
public class TreeBeanUtil {
     ...
     * @return
     */
    public final static List<TreeBean> getFatherNode(List<TreeBean> treesList){
        List<TreeBean> newTrees = new ArrayList<TreeBean>();
        for (TreeBean mt : treesList) {
     ...
     * @return
     */
    private final static List<TreeBean> getChildrenNode(Long pId, List<TreeBean> treesList){
        List<TreeBean> newTrees = new ArrayList<TreeBean>();
        for (TreeBean mt : treesList) {
